...
fruits.forEach((value) => console.log(value)); // 고차함수 forEach

//forEach를 만들어보기
function rotate(array, action) {
...
// fillter 조건에 맞는 모든 아이템들을 새로운 배열로!
...
result = ['park', 'sejin'].flatMap((text) => text.split(''));
console.log(result);
